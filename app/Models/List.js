        ...
        <div class="col-4">    
          <div class="card my-3 border-${this.bgColor} shadow">
            <div class="card-header text-right bg-${this.bgColor}">
              ...
              <h4 class="text-center">${this.Checked}/${this.length}</h4>
            </div>
              <div class="card-body">
                ${this.Items}
              </div>
              <form class="form-inline align-self-center py-3" onsubmit="app.itemController.createItem('${this.listId}')">
                <input type="text" class="form-control" name="listItem" id="${this.listId}" placeholder="Add Task" required minlength="3" maxlength="50">
